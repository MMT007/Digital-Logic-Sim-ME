	...
	public static class BuiltinSimChipCreator
	{
		public static BuiltinSimChip CreateFromName(string name, SimPin[] inputPins, SimPin[] outputPins)
		{
			switch (name)
			{
				...
				case BuiltinChipNames.MXName: return new BuiltinMX(inputPins,outputPins);
				case BuiltinChipNames.PixelDisplayName : return new BuiltinPixelDisplay(inputPins,outputPins);
				default:
